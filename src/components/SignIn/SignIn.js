    ...
    render(){
        ...
        <div className="measure">
            ...
            <div className="mt3">
                ...
                <input 
                    className="pa2 white input-reset ba b--white-20 bg-transparent hover-bg-black hover-white w-100" 
                    type="email" 
                    name="email-address"  
                    id="email-address"
            ...
            <div className="mv3">
                ...
                <input 
                    className="b pa2 white input-reset ba b--white-20 bg-transparent hover-bg-black hover-white w-100" 
                    type="password" 
                    name="password"  
                    id="password"
